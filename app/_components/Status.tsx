...
export const Status = () => {
    ...
    <Section className="flex max-lg:flex-col items-start gap-4">
        {/* <Card className="flex-[3] w-full p-4 flex flex-col gap-2">Side Project</Card>
